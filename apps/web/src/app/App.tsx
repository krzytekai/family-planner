...
function FamilyPlanner({ family, canAdmin, adminOpen, setAdminOpen, displayName }: FamilyPlannerProps) {
  ...
  function openContextualQuickAdd() {
    ...
    else if (activeView === 'shopping') setShoppingCreateRequest((value) => value + 1)
    else if (canCreateTasks) setQuickTaskOpen(true)
  }
