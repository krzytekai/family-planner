...
import { CalendarDays, CheckSquare, Home, MoreHorizontal, Plus, ShieldCheck, ShoppingCart, UserRoundCog, WalletCards, X } from 'lucide-react'
...
export function MobileNav({ activeView, canBudget, canQuickAdd, onNavigate, onQuickAdd, canAdmin, isPlatformAdmin, onAdmin, onPlatformAdmin, canCreateFamily, onCreateFamily }: Props) {
