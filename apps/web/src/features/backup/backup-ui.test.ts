...
const admin=read('src/features/admin/AdminPanel.tsx'),ui=read('src/features/backup/components/BackupExportSection.tsx'),adapter=read('src/features/backup/export-file.ts'),repo=read('src/features/backup/api/backup-repository.ts')
